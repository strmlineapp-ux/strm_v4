  ...
  if (loading) {
    return (
      <div className="flex bg-background min-h-screen items-center justify-center">
        <span className="material-symbols-outlined animate-spin" style={{ fontSize: '48px', fontVariationSettings: "'wght' 100" }}>
          sync
        </span>
      </div>
    );
  ...
  if (isPending) {
    return (
      <div className="flex flex-col bg-background min-h-screen items-center justify-center p-8 text-center text-foreground flex-col gap-4">
         <span className="material-symbols-outlined" style={{ fontSize: '48px', fontVariationSettings: "'wght' 100" }}>
           lock_person
         </span>
    ...
    <div className="flex bg-background min-h-screen items-center justify-center p-4">
      <div className="w-full max-w-sm space-y-8 flex flex-col items-center">
        <div className="flex items-center gap-2 mb-8">
           <span className="material-symbols-outlined" style={{ fontSize: '48px', fontVariationSettings: "'wght' 200" }}>
             water_lux
           </span>
        ...
        <button 
          ...
          className="flex w-full items-center justify-center gap-3 bg-transparent hover:bg-muted/50 border border-input rounded-md px-6 py-4 transition-colors"
        >
          <span className="material-symbols-outlined text-muted-foreground mr-2 group-hover:text-primary transition-colors">
            login
          </span>
